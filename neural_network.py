...
plt.title('Training Loss vs iterations RHC')
plt.savefig('nn_train_iterations_curve_rhc.png')
...
plt.xlabel('Number of Iterations')
plt.ylabel('Training Loss')
plt.title('Training Loss vs iterations SA')
plt.savefig('nn_train_iterations_curve_sa.png')
...
plt.xlabel('Number of Iterations')
plt.ylabel('Training Loss')
plt.title('Training Loss vs iterations for Backpropagation')
plt.savefig('nn_train_iterations_curve_backprop.png')
...
plt.xlabel('Number of Iterations')
plt.ylabel('Training Loss')
plt.title('Training Loss vs iterations GA')
plt.savefig('nn_train_iterations_curve_ga.png')
...
plt.title('Times for Algorithms')
