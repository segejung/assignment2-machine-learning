...
## Graph fitness over increasing problem size
...
plt.title('Fitness vs Problem Size (CPP)')
plt.xlabel('Problem Size')
plt.ylabel('Fitness')
plt.legend()
plt.savefig('CPP fitness.png')
...
plt.title('Computation Time vs Problem Size (CPP)')
plt.legend()
plt.xlabel('Problem Size')
plt.ylabel('Computation Time (s)')
plt.savefig('CPP computation.png')
...
plt.title('Fitness over iterations (CPP)')
plt.legend()
plt.xlabel('Iterations')
plt.ylabel('Fitness')
plt.savefig('CPP_iterations.png')
...
plt.title('Simulated Annealing (CPP)')
plt.legend()
plt.xlabel('Iterations')
plt.ylabel('Fitness')
plt.savefig('CPP SA.png')
